    ...
    <body>
        ...
        <section>
                ...
                <div class="contenuProfil">
                    <div class="container marketing">
                        <div class="row featurette">
                            ...
                            <div class="miniDiapo">
                            	<div id="slideshow">
                                    <div><img src="img/profil/moi.jpg"  alt="moi"  /></div>
            ...
            <div class="experience">
                <div class="container marketing">
                    ...
                    <div class="row featurette">
                        <div class="col-md-7">
                            ...
                            <p class="lead wow fadeInLeft" data-wow-duration="2s">
                                ...
                                Vous devez tuer les ciseaux et les rasoirs du méchant barbier... 
                            </p>
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="row featurette">
                        ...
                        <div class="col-md-7">
                        <h2 class="featurette-heading">Développement partiel d'un site internet.</h2>
                        <p class="lead">
            ...
            <div class="contact">
				...
				?>
				<form class="form-horizontal wow fadeIn" method="post" data-wow-duration="4s">
        ...
        <!-- DEBUT - FOOTER -->
        <footer> 
			<a href="https://www.facebook.com/alexis.prevostmaynen" >          <img src="img/contact/fb.png" alt="facebook" /></a>
            <a href="https://twitter.com/Draxxo76" >                           <img src="img/contact/tw.png" alt="twitter" /> </a>
            <a href="https://plus.google.com/u/0/100298376196903882871/posts" ><img src="img/contact/g.png"  alt="google" />  </a>
        	<a href="https://www.linkedin.com/in/alexisprevostmaynen" >        <img src="img/contact/lk.png" alt="linkedin" /></a>
